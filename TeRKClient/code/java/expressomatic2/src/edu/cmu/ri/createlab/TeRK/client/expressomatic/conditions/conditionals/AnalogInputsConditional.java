package edu.cmu.ri.createlab.TeRK.client.expressomatic.conditions.conditionals;
...
public class AnalogInputsConditional extends AbstractConditional
   ...
   public boolean evaluate(ServiceManager serviceManager)
      {
      AnalogInputsService analogInputsService = (AnalogInputsService)serviceManager.getServiceByTypeId(AnalogInputsService.TYPE_ID);
