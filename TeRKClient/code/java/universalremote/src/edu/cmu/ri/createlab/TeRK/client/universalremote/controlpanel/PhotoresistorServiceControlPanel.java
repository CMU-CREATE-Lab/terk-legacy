 ...
 */
final class PhotoresistorServiceControlPanel extends AbstractServiceControlPanel
   {
   ...
   PhotoresistorServiceControlPanel(final ControlPanelManager controlPanelManager, final PhotoresistorService service)
      {
