...
public class StepCellRenderer extends AbstractListCellRenderer
   ...
   if (value instanceof SequenceStep)
      ...
      String expressionLabel = s.getExpression().getName();
      ...
      g.drawImage(getExpressionIcon(s.getExpression().getName()).getImage(), 5, 5, this);

      g.drawString(expressionLabel, 0, STEP_CELL_HEIGHT - 25);
