...
public abstract class AbstractListCellRenderer extends JLabel implements ListCellRenderer, SwingConstants
   ...
   private static Hashtable<String, ImageIcon> sequenceImages = null;
   ...
   public static void loadSequenceImages(String sequencePath)
      {
      sequenceImages = new Hashtable<String, ImageIcon>();

      File iconsDir = new File(sequencePath + ICON_DIR_STRING);
      ...
      for (File f : iconFiles)
         ...
         try
            ...
            sequenceImages.put(name, new ImageIcon(img));
            }
         catch (Exception e)
            {
            }
   ...
   protected ImageIcon getSequenceIcon(String name)
      {
      if (sequenceImages == null || name == null)
         {
         return DEFAULT_ICON;
         }

      ImageIcon icon = sequenceImages.get(name);
      if (icon == null)
         {
         return DEFAULT_ICON;
         }
