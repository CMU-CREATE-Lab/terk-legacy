...
import edu.cmu.ri.mrpl.TeRK.client.expressomatic.conditions.ConditionEvaluator;
...
public class SequencePlayer
   ...
   public void playSequence(QwerkController qwerkController, Sequence sequence)
      {
      ...
      try
         ...
         while (!stopPlaying)
            ...
            // Must evaluate if the transition has completed for the last step
               ...
               if (c != null)
                  {
                  if (conditionEvaluator.evaluate(qwerkController, c))
                     {
                     executeNextStep = true;
                     }
                  }
            ...
            if (executeNextStep)
               ...
               // Load expression onto qwerk
               expressionLoader.loadToQwerk(qwerkController, currentStep.getExpression(), currentStep.getExpresisonSpeed());
      ...
      expressionLoader.stopQwerk(qwerkController);
