 ...
 */
final class ThermistorServiceControlPanel extends AbstractServiceControlPanel
   {
   ...
   ThermistorServiceControlPanel(final ControlPanelManager controlPanelManager, final ThermistorService service)
      {
   ...
   private final class ControlPanelDevice extends AbstractServiceControlPanelDevice
      ...
      private ControlPanelDevice(final int deviceIndex)
         ...
         borderedPanel.add(GUIConstants.createLabel(RESOURCES.getString("label.raw")));
         borderedPanel.add(GUIConstants.createRigidSpacer());
         borderedPanel.add(rawValueTextField);
         borderedPanel.add(GUIConstants.createLabel(RESOURCES.getString("label.celsius")));
         borderedPanel.add(GUIConstants.createRigidSpacer());
