...
final class ConnectionStatePanel
   ...
   private final JLabel connectionStatusLabel = createLabel(RESOURCES.getString("label.status"));
   ...
   private final JLabel portNameLabel = createLabel(RESOURCES.getString("label.port"));
