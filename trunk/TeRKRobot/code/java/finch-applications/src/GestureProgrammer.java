...
import GestureProgrammerUtils.GestureCommand;
import GestureProgrammerUtils.GestureProgram;
import GestureProgrammerUtils.GestureProgrammerView;
import finch.Finch;
...
public class GestureProgrammer
   ...
   private static GestureCommand createGestureCommand(double[] accelerometerState)
      {
      double left = -18 * accelerometerState[0];
      double right = -18 * accelerometerState[0];
      left = left - 10 * accelerometerState[1];
      right = right + 10 * accelerometerState[1];
