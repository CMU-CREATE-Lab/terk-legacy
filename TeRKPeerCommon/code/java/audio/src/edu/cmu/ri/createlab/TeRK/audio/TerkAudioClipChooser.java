...
public final class TerkAudioClipChooser implements AudioClipChooser
   ...
   private final JButton refreshButton = GUIConstants.createButton(RESOURCES.getString("button.label.refresh"), true);
   ...
   public TerkAudioClipChooser()
      {
      clipComboBox.setFont(GUIConstants.FONT_SMALL);
      clipComboBox.setBackground(Color.WHITE);
      clipComboBox.setMinimumSize(clipComboBox.getPreferredSize());
      clipComboBox.setMaximumSize(clipComboBox.getPreferredSize());
   ...
   public boolean isFileSelected()
      {
      SwingUtils.warnIfNotEventDispatchThread("TerkAudioClipChooser.areInputsValid()");
