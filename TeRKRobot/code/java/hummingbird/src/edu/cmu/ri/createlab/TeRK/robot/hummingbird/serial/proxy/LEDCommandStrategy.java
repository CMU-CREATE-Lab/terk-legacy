 ...
 */
final class LEDCommandStrategy extends CreateLabSerialDeviceNoReturnValueCommandStrategy
   {
   ...
   LEDCommandStrategy(final int ledId, final int intensity)
      {
   ...
   LEDCommandStrategy(final boolean[] mask, final int[] intensities)
      {
