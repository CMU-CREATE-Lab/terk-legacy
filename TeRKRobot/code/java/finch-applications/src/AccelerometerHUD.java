...
public class AccelerometerHUD
   ...
   public static void main(final String[] args) throws InterruptedException
      ...
      SwingUtilities.invokeLater(
            ...
            public void run()
               {
               final Component horizontalSpacer = GUIConstants.createRigidSpacer();
               final Component topVerticalSpacer = GUIConstants.createRigidSpacer();
               final Component bottomVerticalSpacer = GUIConstants.createRigidSpacer();
