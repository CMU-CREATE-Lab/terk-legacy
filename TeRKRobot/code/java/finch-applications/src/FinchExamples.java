...
public class FinchExamples
   ...
   public static void main(final String[] args)
      {
      //Scans the system (console) input for user text
   ...
   private static void menu()
      ...
      System.out.println("Front = Position ColorBlend");
      System.out.println("Left = Light Follow");
      System.out.println("Right = GoTo string");
      System.out.println("Back = Quit");
      ...
      switch (run)
         ...
         case 1:
            //Go to color option
            System.out.println("Time for some ColorBlending!");
            myFinch.sleep(3000);
            colorOption();
            break;
         case 2:
         ...
         case 3:
            //Go to light follow
            System.out.println("Time to follow some lights!");
            myFinch.sleep(3000);
            lightFollow();
            break;
         case 4:
